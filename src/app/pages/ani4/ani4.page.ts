...
export class Ani4Page implements OnInit {
  ...
  ngOnInit() {
    this.squareA = this.animationCtrl.create()
      .addElement(document.querySelector('.square-a')) //cambniamos esto
      .keyframes([
    ...
    this.squareB = this.animationCtrl.create()
      .addElement(document.querySelector('.square-b')) //cambiamos esto
      .keyframes([
    ...
    this.squareC = this.animationCtrl.create()
      .addElement(document.querySelector('.square-c')) //cambiamos esto
      .duration(5000)
      .keyframes([
